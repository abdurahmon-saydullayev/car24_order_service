...
type CreateMechanic struct {
	...
	PricePerHour string `protobuf:"bytes,4,opt,name=price_per_hour,json=pricePerHour,proto3" json:"price_per_hour,omitempty"`
}
...
func (x *CreateMechanic) GetPricePerHour() string {
	if x != nil {
		return x.PricePerHour
	}
	return ""
...
var file_mechanic_proto_rawDesc = []byte{
	...
	0x5f, 0x70, 0x65, 0x72, 0x5f, 0x68, 0x6f, 0x75, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
